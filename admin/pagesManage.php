...
<head>
	...
	<title>Admin Update Pages</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit Pages </h2>
                  ...
                  <option value="pagesManage.php?type=terms">terms and condition</option>
                  <option value="pagesManage.php?type=privacy">privacy and policy</option>
                  <option value="pagesManage.php?type=aboutus">aboutus</option> 
                </select>
												</div>
											</div>
